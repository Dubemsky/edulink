...
def community_page(request):
    if request.method == 'GET':
        ...
        return render(request, "myapp/students/community_page.html", {"initial_users": users_list})
...
def teachers_community_page(request):
    if request.method == 'GET':
        ...
        return render(request, "myapp/teachers/teachers_community_page.html", {"initial_users": users_list})
